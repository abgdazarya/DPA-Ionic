...
export class SimulasiMpHttpClient {
  constructor(
    private storageService: StorageService,
    private httpClient: HttpClientService
  ) {}
  private mainPath = environment.apiEndpoint + environment.apiPaths.simulasiMp;
  ...
  post(
    ...
    const token = this.storageService.getStorage(StorageKeyEnum.REFRESH_TOKEN);
