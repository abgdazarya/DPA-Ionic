...
export class MenuHttpClient {
  constructor(
    private storageService: StorageService,
    private httpClient: HttpClientService
  ) {}
  private mainPath = environment.apiEndpoint + environment.apiPaths.menu;
  ...
  upload(
    ...
    return this.httpClient.upload(this.mainPath + url, body, options);
  }
