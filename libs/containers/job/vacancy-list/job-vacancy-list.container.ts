...
@Component({
  selector: 'app-job-vacancy-list-container',
  templateUrl: './job-vacancy-list.container.html',
  providers: [
    ProfileRepository,
    MenuJobRepository,
    MenuJobInteractionRepository,
...
export class VacancyListContainer implements OnInit, OnDestroy, OnChanges {
