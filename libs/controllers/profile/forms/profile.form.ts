...
class ProfileFormRule {
  ...
  public getFormGroup(): FormGroup {
    return new FormGroup({
      ...
      idKotaKabupaten: new FormControl(null, [Validators.required]),
      idKecamatan: new FormControl(null, [Validators.required]),
      idKelurahanDesa: new FormControl(null, [Validators.required]),
      kelurahanDesa: new FormControl(null, [Validators.required]),
    });
  }
}
